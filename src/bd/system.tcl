...
proc create_root_design { parentCell } {
  ...
  set AXI_BayerToRGB_1 [ create_bd_cell -type ip -vlnv digilentinc.com:user:AXI_BayerToRGB AXI_BayerToRGB_1 ]

  # Create instance: AXI_GammaCorrection_0, and set properties
  set AXI_GammaCorrection_0 [ create_bd_cell -type ip -vlnv digilentinc.com:user:AXI_GammaCorrection AXI_GammaCorrection_0 ]
...
\
  ...
  connect_bd_net -net DVIClocking_0_SerialClk  [get_bd_pins DVIClocking_0/SerialClk] \
  [get_bd_pins rgb2dvi_0/SerialClk]
  connect_bd_net -net DVIClocking_0_aLockedOut  [get_bd_pins DVIClocking_0/aLockedOut] \
  ...
  connect_bd_net -net PixelClk_Generator_clk_out1  [get_bd_pins DVIClocking_0/PixelClk] \
  ...
  connect_bd_net -net clk_wiz_1_locked  [get_bd_pins video_dynclk/locked] \
  [get_bd_pins DVIClocking_0/aLockedIn]
  connect_bd_net -net clk_wiz_1_pxl_clk_5x  [get_bd_pins video_dynclk/pxl_clk_5x] \
  [get_bd_pins DVIClocking_0/PixelClk5X]
  ...
  [get_bd_pins AXI_BayerToRGB_1/StreamClk] \
  [get_bd_pins AXI_GammaCorrection_0/StreamClk] \
  ...
  [get_bd_pins AXI_BayerToRGB_1/sStreamReset_n] \
  [get_bd_pins AXI_GammaCorrection_0/aAxiLiteReset_n] \
  [get_bd_pins AXI_GammaCorrection_0/sStreamReset_n] \
  ...
  [get_bd_pins AXI_GammaCorrection_0/AxiLiteClk] \
